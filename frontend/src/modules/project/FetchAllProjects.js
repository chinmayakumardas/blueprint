...
import { fetchAllProjects, clearProjects } from '@/store/features/in-project/projectSlice'; // Corrected import
...
useEffect(() => {
  if (!projects.length && status.fetchAllProjects === 'idle') {
    dispatch(fetchAllProjects());
  }
}, [dispatch, projects.length, status.fetchAllProjects]);
